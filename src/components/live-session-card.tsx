...
export function LiveSessionCard({ onStartTimer }: LiveSessionCardProps) {
    ...
    const handleStart = () => {
        ...
        onStartTimer({ mode, activityName: subject, activityType, duration, category: subject, tags });
    };
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                        <div className="space-y-8">
                            ...
                            <div className="grid gap-2 mt-4">
                                ...
                                <TagInput tags={tags} onTagsChange={setTags} placeholder="Add tags (e.g. #exam, #project)..." />
                            </div>
                        </div>
